export default class niveau2_3_3 extends Phaser.Scene {
    ...
    this.add.text(620, 280, "Quels sont les risques de rechute après avoir arrêté les champignons hallucinogènes ?", {
      fontFamily: 'Georgia, "Goudy Bookletter 1911", Times, serif',
      fontSize: "22pt"
    }).setOrigin(0.5, 0.5);
    this.add.text(350, 415, "a) 25 %", {
      fontFamily: 'Georgia, "Goudy Bookletter 1911", Times, serif',
      fontSize: "22pt"
    }).setOrigin(0.5, 0.5);
    this.add.text(900, 415, "c) 20 %", {
      fontFamily: 'Georgia, "Goudy Bookletter 1911", Times, serif',
      fontSize: "22pt"
    }).setOrigin(0.5, 0.5);
    this.add.text(625, 415, "b) 15 %", {
      fontFamily: 'Georgia, "Goudy Bookletter 1911", Times, serif',
      fontSize: "22pt"
    }).setOrigin(0.5, 0.5);
