...
export default class selection extends Phaser.Scene {
  ...
  update() {
    ...
    //if (Phaser.Input.Keyboard.JustDown(clavier.space) == true) { 
      if (this.physics.overlap(player, this.porte1_1)) {
      this.scene.switch("niveau1");
      this.porte1_1.destroy(); // on destroy la porte pour ne pas y retourner
      }
      if (this.physics.overlap(player, this.porte1_2)) {
         this.scene.switch("niveau1");
      this.porte1_2.destroy();
      }
      if (this.physics.overlap(player, this.porte1_3)) {
         this.scene.switch("niveau1");
      this.porte1_3.destroy();
      }
      if (this.physics.overlap(player, this.porte1_4)){
         this.scene.switch("niveau1");
      this.porte1_4.destroy();
      }
      if (this.physics.overlap(player, this.porte1_5)){
         this.scene.switch("niveau1");
      this.porte1_5.destroy();
      }

      if (this.physics.overlap(player, this.porte2_1)){
         this.scene.switch("niveau2_1_1");
      this.porte2_1.destroy();
      }
      if (this.physics.overlap(player, this.porte2_2)){
         this.scene.switch("niveau2_1_1");
      this.porte2_2.destroy();
      }
      if (this.physics.overlap(player, this.porte2_3)){
         this.scene.switch("niveau2_1_1");
      this.porte2_3.destroy();
      }
      if (this.physics.overlap(player, this.porte2_4)){ this.scene.switch("niveau2_1_1");
      this.porte2_4.destroy();
      }
      if (this.physics.overlap(player, this.porte2_5)){ this.scene.switch("niveau2_1_1");
      this.porte2_5.destroy();
      }

      if (this.physics.overlap(player, this.porte3_1)){
         this.scene.start("niveau3");
      this.porte3_1.destroy();
      }
      if (this.physics.overlap(player, this.porte3_2)){
         this.scene.start("niveau3");
      this.porte3_2.destroy();
      }
      if (this.physics.overlap(player, this.porte3_3)){
         this.scene.start("niveau3");
      this.porte3_3.destroy();
      }
      if (this.physics.overlap(player, this.porte3_4)){
         this.scene.start("niveau3");
      this.porte3_4.destroy();
      }
      if (this.physics.overlap(player, this.porte3_5)) {
        this.scene.start("niveau3");
      this.porte3_5.destroy();
      }
     

      if (this.physics.overlap(player, this.porte4_1)) {
        this.scene.switch("niveau4");
      this.porte4_1.destroy();
      }
      if (this.physics.overlap(player, this.porte4_2)) {
        this.scene.switch("niveau4");
      this.porte4_2.destroy();
      }
      if (this.physics.overlap(player, this.porte4_3)) {
        this.scene.switch("niveau4");
      this.porte4_3.destroy();
      }
      if (this.physics.overlap(player, this.porte4_4)) {
        this.scene.switch("niveau4");
      this.porte4_4.destroy();
      }
      if (this.physics.overlap(player, this.porte4_5)) {
        this.scene.switch("niveau4");
      this.porte4_5.destroy();
      }
      if (this.physics.overlap(player, this.porteFin)) {
