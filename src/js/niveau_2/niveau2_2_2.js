export default class niveau2_2_2 extends Phaser.Scene {
    // constructeur de la classe
    constructor() {
      super({
        key: "niveau2_2_2" //  ici on précise le nom de la classe en tant qu'identifiant
      });
    }
    preload() {
    ...
    this.add.text(600, 300, "Combien de personnes finnisent en prison à cause de la drogue ?", {
      fontFamily: 'Georgia, "Goudy Bookletter 1911", Times, serif',
      fontSize: "22pt"
    }).setOrigin(0.5, 0.5);
    this.add.text(350, 415, "a) 20", {
      fontFamily: 'Georgia, "Goudy Bookletter 1911", Times, serif',
      fontSize: "22pt"
    }).setOrigin(0.5, 0.5);
    this.add.text(900, 415, "c) 15", {
      fontFamily: 'Georgia, "Goudy Bookletter 1911", Times, serif',
      fontSize: "22pt"
    }).setOrigin(0.5, 0.5);
    this.add.text(625, 415, "b) 25", {
      fontFamily: 'Georgia, "Goudy Bookletter 1911", Times, serif',
      fontSize: "22pt"
    }).setOrigin(0.5, 0.5);
