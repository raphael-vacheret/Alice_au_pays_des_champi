export default class niveau2_3_2 extends Phaser.Scene {
    // constructeur de la classe
    constructor() {
      super({
        key: "niveau2_3_2" //  ici on précise le nom de la classe en tant qu'identifiant
      });
    }
    preload() {
    ...
    this.add.text(620, 280, "La consommation de cocaïne peut entrainer des problèmes cardiaques :", {
